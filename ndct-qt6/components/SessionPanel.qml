        ...
        delegate: ItemDelegate {
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        sessionEntryBg.color: highlighted ? Qt.darker(config.PopupActiveColor, 1.2) : Qt.darker(config.PopupColor, 1.2)
                    }
                }
            ]
    ...
    Button {
        ...
        states: [
            State {
                ...
                PropertyChanges {
                    sessionButtonBg.color: Qt.darker(config.SessionButtonColor, 1.2)
                }
            },
            State {
                name: "hovered"
